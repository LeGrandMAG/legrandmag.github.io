...
export const upcomingProjects = [
    ...
    {
        id: nanoid(),
        title: "Congo Excellence",
        description:"A single page application with quizzes to help people know more about excellent things about Congo.",
        illustration:"./projects/meme.gif",
        link:"243studio.github.io/CongoExcellence",
        sourceCode: "https://github.com/243Studio/CongoExcellence"  
    },
    {
        id: nanoid(),
        title: "A Web application that let the user update a picture, put a text in to support the FARDC and share it on social media.",
        description:"A Single page application that displays all the graphic design project I have worked on.",
        illustration:"./projects/meme.gif",
        link:"243studio.github.io/CongoExcellence",
        sourceCode: "https://github.com/243Studio/SoutienFARDC"  
    },
