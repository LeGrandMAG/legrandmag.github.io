...
export const work = [
    {
        company: "WEPO",
        position:'CEO & Marketing Management',
        location: 'Seoul, South Korea',
        date: 'April 2021 - Present',
        responsibilities: [
            "Wrote functional requirement documents and guides.",
            "Drove over 190+ .... to our Social Network by consistently creating content and collaborating with other member of the communities, representing a 43% quarter-on-quarter increase", 
...
export const softSkills = [
    "growth mindset", "creativity", "focus mastery", "innovation", "communication skills", "storytelling", "culture awareness", "critical thinking", " leadership", "emotional intelligence"
]
...
Measurable: accomplished X as measure by Y by doing Z
*/